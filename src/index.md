...
function parseBaseRow(d) {
  ...
  mes_ano_vencimento_suspensiva: (() => { const dt = parseDate(pickField(d, "vencimento_da_suspensiva_pbi", "vencimento_da_suspensiva")); return dt instanceof Date && !isNaN(dt) ? `${String(dt.getMonth()+1).padStart(2,"0")}/${dt.getFullYear()}` : ""; })(),
