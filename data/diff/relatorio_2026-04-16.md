# Diferença da base PC 32 - 2026-04-16

- Snapshot atual: `2026-04-16`
- Snapshot anterior: `2026-04-15`
- Total anterior: **1579**
- Total atual: **1579**
...
- Registros com mudança de dados de origem: **0**
- Registros com mudança apenas em campos derivados/status: **1579**

## Mudanças por status

- `status_suspensiva_calc`: **0**
- `status_pub_licitacao_calc`: **858**
- `status_homolog_licitacao_calc`: **523**
- `status_inicio_obra_calc`: **0**
- `status_regra_casa_civil_calc`: **32**
